...
from app.reminders import create_upcoming_booking_notifications
...
def seed_database():
    ...
    with app.app_context():
        ...
        # Przypisanie wyposażenia do sal
        rooms[0].equipment = [
            equipment_list[1],
            equipment_list[3]
        ]
        ...
        # Zapisujemy użytkowników i sale
        db.session.commit()

        # Przykładowe tytuły rezerwacji
        titles = [
            "Spotkanie zespołu",
            "Code review",
        ...
        # Tworzenie 20 losowych rezerwacji
        for i in range(20):
            ...
            # Dodaj rezerwację tylko,
            # jeżeli sala jest wolna
